    ...
    constructor(private contestservice: ContestService, private router:Router){
     ...
     columnDefs = [
        ...
        checkboxSelection: true, suppressSorting: true,
                suppressMenu: true},
        {headerName: 'AgentNo', field: 'agentNo' },
        {headerName: 'Name', field: 'agentName'},
        {headerName: 'TranDate', field: 'tranDate'},
        {headerName: 'NetAmount', field: 'netAmount'},
        {headerName: 'RecoverableAmount', field: 'recoverbleAmount'},
        {headerName: 'DeviationAmt', field: 'deviationAmt'},
        {headerName: 'AdvancePayout', field: 'advancePayout'},
        {headerName: 'AdvanceRecoverable', field: 'advanceRecoverable'},
        {headerName: 'MaxRecoverableAmt', field: 'maxRecoverableAmt'},
        {headerName: 'NetPayout', field: 'netPayout'},
        {headerName: 'PRFComment', field: 'prfComment',editable:true, valueSetter: this.nameValueGetter , valueGetter: ""},
